...
A total of 945 units were moved with essentially zero return.
...
- Set of 6 Soldier Skittles → 80 units at £0 profit
...
- 2,735 returning customers generated £5.62M across 14,726
  orders — that's 76.1% of total revenue from just 65.4%
  of the customer base.
- 4,185 new customers brought in £1.77M across 4,461 orders,
  contributing 23.9% of revenue.

Returning customers place far more orders per person:
- Returning: ~5.4 orders per customer (14,726 / 2,735)
- New: ~1.1 orders per customer (4,461 / 4,185)
...
2,735 out of 4,185 new customers ever came back (~65.4%
retention), meaning ~34.6% of new customers never returned.
...
/* Analysis Insight:
67.17% repeat rate — 2,811 of 4,185 customers bought 2+ times.
Only 1,374 (32.83%) were one-time buyers.

This confirms Scenario 4: strong customer loyalty with nearly
7 in 10 customers returning. These repeat buyers drive 76.1% of
total revenue.

The 1,374 one-time buyers are the key opportunity — converting
